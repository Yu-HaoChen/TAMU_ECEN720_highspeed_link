...
bit_period=round(1e12/8e9);	% This is 10Gb/s with 1ps step time
opt_sample=1*(0e-2); % Used in plotting pulse response

% Load Channel Impulse Response
load C:\Users\harri\Downloads\ir_B12.mat;
...
eq_tap_number=4;    % Equalization Tap Number
precursor_number=1; % Number of Pre-Cursor Taps
num_bits=6;         % TX Equalization Resolution
...
Htitle = get(AX, 'title');
set(Htitle, 'string', '12" BP 8Gb/s 0.5V Pulse Response','FontName','utopia', 'FontSize', [20], 'Color', [0 0 0]);
